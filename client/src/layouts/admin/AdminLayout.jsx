...
import { 
  ...
  LogOut, Menu, Bell, Search, ChevronLeft, ChevronRight, Brain
} from 'lucide-react';
...
const ADMIN_LINKS = [
  ...
  { path: '/admin/doctors', name: 'Doctor Management', icon: Stethoscope },
  { path: '/admin/patients', name: 'Patient Management', icon: UserCog },
  { path: '/admin/diseases', name: 'Diseases & Symptoms', icon: Activity },
  { path: '/admin/ml-model', name: 'ML Models & Data', icon: Brain },
  { path: '/admin/reports', name: 'Reports & Logs', icon: FileText },
      ...
      >
        <div className="h-16 flex items-center justify-between px-4 border-b">
          <div className={`flex items-center gap-2 overflow-hidden transition-all ${sidebarOpen ? 'opacity-100 w-auto' : 'opacity-0 w-0'}`}>
            ...
            <span className="font-black tracking-tight whitespace-nowrap">Medica Admin</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 group relative cursor-pointer" onClick={handleLogout}>
              <div className="text-right hidden sm:block">
                ...
                <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-semibold mt-1">Logout</p>
              </div>
